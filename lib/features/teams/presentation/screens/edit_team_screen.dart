...
class _EditTeamScreenState extends State<EditTeamScreen> {
  ...
  void initState() {
    ...
    titleController = TextEditingController(text: widget.team.title);

    descriptionController = TextEditingController(
      text: widget.team.description,
    );

    techStackController = TextEditingController(text: widget.team.techStack);
  ...
  Future<void> saveChanges() async {
    ...
    Future<void> deleteTeam() async {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Team deleted successfully 🗑️")),
        );
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: decoration("Team Name"),
            ),
            ...
            TextField(
              ...
              decoration: decoration("Tech Stack"),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: Colors.red),
                onPressed: isLoading ? null : deleteTeam,
